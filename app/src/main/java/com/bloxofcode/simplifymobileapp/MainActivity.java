...
public class MainActivity extends AppCompatActivity implements OnRemoteOperationListener, OnDatatransferProgressListener {
    ...
    private void startUpload() {
        ...
        Log.d("Remote_Path",fileToUpload.getAbsolutePath());
        String remotePath = FileUtils.PATH_SEPARATOR + fileToUpload.getName();
        Log.d("Remote_Path",remotePath);
    ...
    private void onSuccessfulDownload(DownloadRemoteFileOperation operation, RemoteOperationResult result) {
        File downFolder = new File(getCacheDir(), getString(R.string.download_folder_path));
        File downloadedFile = downFolder.listFiles()[0];
        Log.d("Download",downloadedFile.getAbsolutePath());
